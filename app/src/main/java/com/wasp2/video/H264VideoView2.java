...
public class H264VideoView2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public H264VideoView2(Context context) {
        super(context);
        customInit();
    }

    public H264VideoView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        customInit();
    }

    public H264VideoView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if ((mMediaCodec != null)) {
            if (mIsCodecConfigured) {
                ...
                if (index >= 0) {
                    ...
                    if (b != null) {
                        //Log.i("STREAMING", "TO SCREEN");


                        InputImage image = InputImage.fromByteArray(frame.getByteData(),
                              640,
                               368,
                                0,
                                InputImage.IMAGE_FORMAT_YV12 //IMAGE_FORMAT_NV21 // or
                        );
